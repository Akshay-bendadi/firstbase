...
- Generated GitHub Dependency Review runs in its own pull-request workflow so push CI does not show a skipped dependency-review step. It skips with a notice until GitHub dependency graph support is enabled for the repository.
