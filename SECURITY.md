...
- CI can run Socket Security policy scans when `SOCKET_SECURITY_API_KEY` is configured. `SOCKET_ORG` can override the Socket CLI default organization when needed.
